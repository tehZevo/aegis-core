...
from aegis_core.temporal_histogram import TemporalHistogram
...
if __name__ == '__main__':
  input_shape = [32, 32, 3]
  #latent_size = 32 #works p gud
  latent_size = 2 #for unity testing
  acti = "tanh"
  ...
  opt = Adam(1e-3)
  vae, encoder, decoder = build_vae(encoder, decoder, input_shape, latent_size, kl_scale=10., opt=opt)
  vae.summary()
  encoder.summary()
  decoder.summary()
  ...
  start_nodes([
    ...
    VAENode(12403, vae, encoder, decoder, input_url="12400", generator_url="12402").set_niceness(0.5),
